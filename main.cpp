...
int main() {
    ...
    if (yolo.load_param("best.param") || yolo.load_model("best.bin")) {
        std::cerr << "Error cargando modelo (asegurate de haber copiado los .bin y .param a build/)\n";
        return -1;
    }
    std::cout << "Modelo cargado. Iniciando captura...\n";
